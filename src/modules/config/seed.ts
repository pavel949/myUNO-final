...
export async function seedConfig(db: PrismaClient) {
  ...
  await db.configParameter.createMany({
    data: [
      ...
      {
        key: 'merchant.legal_name',
        valueType: 'string',
        defaultValue: 'Ignatev Estate Co., Ltd',
        scopeableTo: 'global',
        groupKey: 'merchant',
        description: 'The legal entity money is paid to, as it appears on instructions and receipts',
      },
      {
        key: 'merchant.tax_id',
        valueType: 'string',
        // The company registration number, which is also the corporate tax id.
        // Deliberately NOT the director's personal tax id — see doc 04 §11.
        defaultValue: '083-5-56602358-7',
        scopeableTo: 'global',
        groupKey: 'merchant',
        description: 'Corporate tax / DBD registration number shown on receipts',
      },
      {
        key: 'merchant.established_on',
        valueType: 'string',
        // Blank on purpose: the founder left it blank, and a plausible date is
        // still an invented one (CLAUDE.md).
        defaultValue: '',
        scopeableTo: 'global',
        groupKey: 'merchant',
        description: 'Date of establishment (ISO). Empty until the founder supplies it',
      },
      {
        key: 'merchant.bank_name',
        valueType: 'string',
        defaultValue: 'Bank of Ayudhya (Krungsri)',
        scopeableTo: 'global',
        groupKey: 'merchant',
        description: 'Bank holding the company account',
      },
      {
        key: 'merchant.bank_account_name',
        valueType: 'string',
        defaultValue: 'Ignatev Estate Co., Ltd',
        scopeableTo: 'global',
        groupKey: 'merchant',
        description: 'Account holder name the payer must transfer to',
      },
      {
        key: 'merchant.bank_account_number',
        valueType: 'string',
        defaultValue: '475-1-22131-3',
        scopeableTo: 'global',
        groupKey: 'merchant',
        description: 'Company account number for domestic transfers',
      },
      {
        key: 'merchant.bank_swift',
        valueType: 'string',
        defaultValue: 'AYUDTHBK',
        scopeableTo: 'global',
        groupKey: 'merchant',
        description: 'SWIFT/BIC for transfers from outside Thailand',
      },
      {
        key: 'merchant.bank_transfer_enabled',
        valueType: 'boolean',
        defaultValue: true,
        scopeableTo: 'project',
        groupKey: 'merchant',
        description: 'Whether a payer may settle by bank transfer',
      },
      {
        key: 'merchant.bank_transfer_window_hours',
        valueType: 'int',
        defaultValue: 72,
        scopeableTo: 'project',
        groupKey: 'merchant',
        description: 'How long a transfer instruction stays valid before ops chase it',
      },
      {
        key: 'booking.payment.methods_enabled',
        valueType: 'json',
        defaultValue: ['cash', 'bank_transfer'],
        scopeableTo: 'project',
        groupKey: 'booking',
        description: 'Which payment methods are offered (card_provider only once a licensed provider is live — Q8)',
      },
      {
