...
export default async function MCPortalPage({ searchParams }: MCPortalPageProps) {
  ...
  const labels = await getLabels({
    ...
    'mc.bookings.sheet_close': 'Close',
    'mc.bookings.sheet_amount_due': 'Amount due',
    'mc.bookings.cash_sheet_title': 'Record cash · {name}',
    'mc.bookings.cash_sheet_hint': 'From the paper receipt book at the desk.',
    'mc.bookings.cash_sheet_counted': 'I have counted {amount} and it is in the safe.',
    'mc.bookings.cash_sheet_submit': 'Record {amount} cash',
    'mc.bookings.cash_sheet_required_hint': 'Both the reference and the count are required.',
