...
/**
 * Guest lifecycle automation (LY-8): the two declared-but-never-dispatched
 * touchpoints become scheduled sends, driven from the cron dispatcher.
 *
...
async function alreadySent(
  db: PrismaClient,
  identityId: string,
  type: 'stay_prearrival_passports' | 'stay_review_prompt',
  bookingId: string
): Promise<boolean> {
