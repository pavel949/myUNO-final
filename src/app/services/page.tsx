...
export default async function ServicesPage() {
  ...
  const labels = await getLabels({
    ...
    'services.browse.search_label': 'Search',
    'services.browse.search_placeholder': 'Cleaning, transfer, chef…',
    'services.browse.sort_label': 'Sort by',
    'services.browse.sort_recent': 'Newest',
    'services.browse.sort_price_asc': 'Price: low to high',
    'services.browse.sort_price_desc': 'Price: high to low',
    'services.browse.sort_rating': 'Best reviewed',
    'services.browse.result_count': '{count} services',
    'services.browse.reviews': '{count} reviews',
