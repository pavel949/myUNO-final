...
const UI_SHELL_KEYS: KeyDef[] = [
  ...
  { key: 'messages.thread.flag_purchase', namespace: 'messages', description: 'Flag message as purchase interest', en: 'Flag as purchase interest', ru: 'Отметить интерес к покупке', th: 'ทำเครื่องหมายสนใจซื้อ', status: NR },
