...
export default async function AccountPage() {
  ...
  const labels = await getLabels({
    ...
    'account.consent.title': 'How your data is used',
    'account.consent.intro':
      'You can withdraw any of these at any time. We keep a record of the change, not of what you withdrew.',
    'account.consent.granted': 'Allowed',
    'account.consent.withdrawn': 'Not allowed',
    'account.consent.purpose.marketing': 'News and offers',
    'account.consent.purpose.property_matching': 'Matching me with properties to buy or rent',
    'account.consent.purpose.analytics': 'Improving the service from how I use it',
