 ...
 *
 * Moved inside the `(admin)` route group (CURSOR_PROMPT phase 2) — it used
 * to render with no sidebar because it sat outside the group entirely. The
 * old `/admin/finance/reconciliation` path now redirects here rather than
 * breaking anyone's bookmark.
 */
