...
const UI_SHELL_KEYS: KeyDef[] = [
  ...
  // Owners audience page — rich sections (how-it-works, trust points, FAQ).
  // EN is the previously hardcoded page copy; RU is an agent draft (doc 05 §1).
  { key: 'audience.owners.how.title', namespace: 'audience', description: 'Owners page: how-it-works section title', en: 'How it works', ru: 'Как это работает', status: NR },
  { key: 'audience.owners.how.step1_title', namespace: 'audience', description: 'Owners page: step 1 title', en: 'List your unit', ru: 'Разместите свой юнит', status: NR },
  { key: 'audience.owners.how.step1_body', namespace: 'audience', description: 'Owners page: step 1 body', en: 'Upload photos, set your rules, choose your engagement type.', ru: 'Загрузите фото, задайте правила, выберите формат сотрудничества.', status: NR },
  { key: 'audience.owners.how.step2_title', namespace: 'audience', description: 'Owners page: step 2 title', en: 'We verify guests', ru: 'Мы проверяем гостей', status: NR },
  { key: 'audience.owners.how.step2_body', namespace: 'audience', description: 'Owners page: step 2 body', en: 'Passports, backgrounds, proof of funds — all confirmed before check-in.', ru: 'Паспорта, проверка, подтверждение средств — всё до заселения.', status: NR },
  { key: 'audience.owners.how.step3_title', namespace: 'audience', description: 'Owners page: step 3 title', en: 'Track everything', ru: 'Следите за всем', status: NR },
  { key: 'audience.owners.how.step3_body', namespace: 'audience', description: 'Owners page: step 3 body', en: 'See every booking, payment, and request in one dashboard. Monthly statements included.', ru: 'Каждое бронирование, платёж и заявка — в одном кабинете. Ежемесячные отчёты включены.', status: NR },
  { key: 'audience.owners.how.step4_title', namespace: 'audience', description: 'Owners page: step 4 title', en: 'Get paid on time', ru: 'Получайте выплаты вовремя', status: NR },
  { key: 'audience.owners.how.step4_body', namespace: 'audience', description: 'Owners page: step 4 body', en: 'Earnings calculated daily. Payouts to your account or card, your choice.', ru: 'Доход рассчитывается ежедневно. Выплаты на счёт или карту — на ваш выбор.', status: NR },
  { key: 'audience.owners.why.title', namespace: 'audience', description: 'Owners page: trust section title', en: 'Why owners trust us', ru: 'Почему нам доверяют собственники', status: NR },
  { key: 'audience.owners.why.point1', namespace: 'audience', description: 'Owners page: trust point 1', en: 'Peace of mind: verified guests and 24/7 support', ru: 'Спокойствие: проверенные гости и поддержка 24/7', status: NR },
  { key: 'audience.owners.why.point2', namespace: 'audience', description: 'Owners page: trust point 2', en: 'Transparency: see every guest, payment, and issue', ru: 'Прозрачность: каждый гость, платёж и вопрос на виду', status: NR },
  { key: 'audience.owners.why.point3', namespace: 'audience', description: 'Owners page: trust point 3', en: 'Compliance done: TM30, taxes, PDPA all handled', ru: 'Комплаенс закрыт: TM30, налоги, PDPA — всё оформляем мы', status: NR },
  { key: 'audience.owners.why.point4', namespace: 'audience', description: 'Owners page: trust point 4', en: 'NOI cap protection: earnings guaranteed to your terms', ru: 'Защита NOI-кэпом: доход гарантирован на ваших условиях', status: NR },
  { key: 'audience.owners.why.point5', namespace: 'audience', description: 'Owners page: trust point 5', en: 'Services at hand: cleaning, repairs, maintenance all vetted', ru: 'Услуги под рукой: уборка, ремонт, обслуживание — все проверены', status: NR },
  { key: 'audience.owners.faq.title', namespace: 'audience', description: 'Owners page: FAQ section title', en: 'Frequently asked', ru: 'Частые вопросы', status: NR },
  { key: 'audience.owners.faq.q1_title', namespace: 'audience', description: 'Owners page: FAQ 1 question', en: 'How much can I earn?', ru: 'Сколько я могу заработать?', status: NR },
  { key: 'audience.owners.faq.q1_body', namespace: 'audience', description: 'Owners page: FAQ 1 answer', en: 'It depends on your unit, location, and engagement type. Our calculator shows realistic projections based on market data.', ru: 'Зависит от юнита, локации и формата сотрудничества. Наш калькулятор показывает реалистичный прогноз на основе рыночных данных.', status: NR },
  { key: 'audience.owners.faq.q2_title', namespace: 'audience', description: 'Owners page: FAQ 2 question', en: 'What if a guest damages the unit?', ru: 'Что если гость повредит юнит?', status: NR },
  { key: 'audience.owners.faq.q2_body', namespace: 'audience', description: 'Owners page: FAQ 2 answer', en: 'Pre-arrival verification and condition reports protect you. Deposits are held by our payment provider, not us. Damage claims are handled fairly and quickly.', ru: 'Вас защищают проверка до заезда и акты состояния юнита. Депозиты держит платёжный провайдер, а не мы. Претензии по ущербу решаются честно и быстро.', status: NR },
  { key: 'audience.owners.faq.q3_title', namespace: 'audience', description: 'Owners page: FAQ 3 question', en: 'Can I use this for my family?', ru: 'Могу ли я пользоваться юнитом сам?', status: NR },
  { key: 'audience.owners.faq.q3_body', namespace: 'audience', description: 'Owners page: FAQ 3 answer', en: 'Yes. Owner stays are zero-rent bookings tracked separately. You can block dates or stay whenever you like.', ru: 'Да. Проживание собственника — бронирования с нулевой арендой, учитываются отдельно. Блокируйте даты и приезжайте, когда хотите.', status: NR },
];
