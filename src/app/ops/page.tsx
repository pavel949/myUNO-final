...
export default async function OpsBoardPage({ searchParams }: OpsBoardPageProps) {
  ...
  const labels = await getLabels({
    ...
    'staff.ops.sheet_close': 'Close',
    'staff.ops.sheet_amount_due': 'Amount due',
    'staff.ops.cash_sheet_title': 'Record cash · {name}',
    'staff.ops.cash_sheet_hint': 'From the paper receipt book at the desk.',
    'staff.ops.cash_sheet_counted': 'I have counted {amount} and it is in the safe.',
    'staff.ops.cash_sheet_submit': 'Record {amount} cash',
    'staff.ops.cash_sheet_required_hint': 'Both the reference and the count are required.',
    'staff.ops.transfer_sheet_title': 'Record transfer · {name}',
    'staff.ops.transfer_sheet_hint': 'The reference from the bank transfer or slip.',
    'staff.ops.transfer_sheet_submit': 'Record {amount} transfer',
    'staff.ops.transfer_sheet_required_hint': 'A bank reference is required.',
    ...
    'staff.ops.ticket_resolve_sheet_title': 'Resolve · {title}',
    'staff.ops.ticket_resolve_submit': 'Resolve ticket',
