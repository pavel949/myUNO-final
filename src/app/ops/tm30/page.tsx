...
export default async function Tm30QueuePage({ searchParams }: Tm30QueuePageProps) {
  ...
  const labels = await getLabels({
    ...
    'staff.tm30.reason_prompt': 'State a reason before viewing this passport. It will be logged with your name.',
    'staff.tm30.reason_placeholder': 'e.g. Verifying arrival identity',
    'staff.tm30.reason_submit': 'View passport details',
    'staff.tm30.reason_required': 'Enter a reason before viewing this passport.',
