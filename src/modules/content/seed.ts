...
const COMMON_KEYS: KeyDef[] = [
  ...
  {
    key: 'provider.become_provider',
    namespace: 'provider',
    description: 'Provider application page heading',
    ru: 'Станьте провайдером услуг',
    en: 'Become a Service Provider',
    th: 'เป็นผู้ให้บริการ',
  },
  {
    key: 'provider.application_intro',
    namespace: 'provider',
    description: 'Provider application intro text',
    ru: 'Присоединитесь к нашей сети поставщиков услуг и начните получать заказы',
    en: 'Join our network of vetted service providers and start accepting orders',
    th: 'เข้าร่วมเครือข่ายผู้ให้บริการที่ได้รับการตรวจสอบและเริ่มยอมรับคำสั่งซื้อ',
  },
  {
    key: 'provider.business_name',
    namespace: 'provider',
    description: 'Form field: business name',
    ru: 'Название компании',
    en: 'Business Name',
    th: 'ชื่อธุรกิจ',
  },
  {
    key: 'provider.business_name_placeholder',
    namespace: 'provider',
    description: 'Placeholder for business name',
    ru: 'Ваша компания',
  ...
  },
  {
    ...
    namespace: 'provider',
    description: 'Form field: business description',
    ru: 'Описание услуг',
    en: 'Business Description',
    th: 'คำอธิบายธุรกิจ',
  },
  {
    key: 'provider.description_placeholder',
    namespace: 'provider',
    description: 'Placeholder for description',
    ru: 'Опишите ваши услуги...',
    en: 'Describe your services...',
    th: 'อธิบายบริการของคุณ...',
  },
  {
    key: 'provider.service_categories',
    namespace: 'provider',
    description: 'Form field: service categories',
    ru: 'Категории услуг',
    en: 'Service Categories',
    th: 'หมวดหมู่บริการ',
  },
  {
    key: 'provider.contact_email',
    namespace: 'provider',
    description: 'Form field: contact email',
    ru: 'Контактный email',
    en: 'Contact Email',
    th: 'อีเมลติดต่อ',
  },
  {
    key: 'provider.contact_phone',
    namespace: 'provider',
    description: 'Form field: contact phone',
    ru: 'Контактный телефон',
    en: 'Contact Phone',
    th: 'เบอร์ติดต่อ',
  },
  {
    key: 'provider.submit_application',
    namespace: 'provider',
    description: 'Button: submit application',
    ru: 'Отправить заявку',
    en: 'Submit Application',
    th: 'ส่งใบสมัคร',
  },
  {
    key: 'provider.submitting',
    namespace: 'provider',
    description: 'Button state: submitting',
    ru: 'Отправка...',
    en: 'Submitting...',
    th: 'กำลังส่ง...',
  },
  {
    key: 'provider.application_received',
    namespace: 'provider',
    description: 'Success message: application received',
    ru: 'Спасибо! Ваша заявка получена',
    en: 'Thank you! Your application has been received',
    th: 'ขอบคุณ! เราได้รับใบสมัครของคุณ',
  },
  {
    key: 'provider.application_received_desc',
    namespace: 'provider',
    description: 'Success message: description',
    ru: 'Мы проверим вашу заявку и свяжемся с вами в ближайшее время',
    en: 'We will review your application and contact you soon',
    th: 'เราจะตรวจสอบใบสมัครของคุณและติดต่อคุณในไม่ช้า',
  },
